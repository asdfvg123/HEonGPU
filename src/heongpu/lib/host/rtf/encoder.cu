...
namespace heongpu
{
    ...
    __host__ HEEncoder<Scheme::RTF>::HEEncoder(HEContext<Scheme::RTF>& context)
    {
    ...
    __host__ void
    HEEncoder<Scheme::RTF>::encode_bfv(Plaintext<Scheme::RTF>& plain,
    ...
    __host__ void
    HEEncoder<Scheme::RTF>::decode_bfv(std::vector<uint64_t>& message,
    ...
    __host__ void
    HEEncoder<Scheme::RTF>::decode_bfv(std::vector<int64_t>& message,
                                       Plaintext<Scheme::RTF>& plain,
                                       const cudaStream_t stream)
    {
        DeviceVector<Data64> temp_memory(slot_count_ + n, stream);
    ...
    __host__ void
    HEEncoder<Scheme::RTF>::decode_bfv(HostVector<uint64_t>& message,
                                       Plaintext<Scheme::RTF>& plain,
                                       const cudaStream_t stream)
    {
        DeviceVector<Data64> temp_memory(slot_count_ + n, stream);
    ...
    __host__ void
    HEEncoder<Scheme::RTF>::decode_bfv(HostVector<int64_t>& message,
                                       Plaintext<Scheme::RTF>& plain,
                                       const cudaStream_t stream)
    {
        DeviceVector<Data64> temp_memory(slot_count_ + n, stream);
