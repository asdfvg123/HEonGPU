...
namespace heongpu
{
    __host__ HEMultiPartyManager<Scheme::RTF>::HEMultiPartyManager(
    ...
    __host__ void HEMultiPartyManager<Scheme::RTF>::generate_public_key_stage1(
        MultipartyPublickey<Scheme::RTF>& pk, Secretkey<Scheme::RTF>& sk,
    ...
    __host__ void HEMultiPartyManager<Scheme::RTF>::generate_public_key_stage2(
        std::vector<MultipartyPublickey<Scheme::RTF>>& all_pk,
        Publickey<Scheme::RTF>& pk, const cudaStream_t stream)
    {
    ...
    __host__ void
    HEMultiPartyManager<Scheme::RTF>::generate_relin_key_method_I_stage_1(
        MultipartyRelinkey<Scheme::RTF>& rk, Secretkey<Scheme::RTF>& sk,
        const ExecutionOptions& options)
    {
        ...
        input_storage_manager(
            sk,
            [&](Secretkey<Scheme::RTF>& sk_)
            {
                output_storage_manager(
                    rk,
                    [&](MultipartyRelinkey<Scheme::RTF>& rk_)
                    {
    ...
    __host__ void
    HEMultiPartyManager<Scheme::RTF>::generate_relin_key_method_I_stage_3(
        MultipartyRelinkey<Scheme::RTF>& rk_stage_1,
        MultipartyRelinkey<Scheme::RTF>& rk_stage_2, Secretkey<Scheme::RTF>& sk,
        const ExecutionOptions& options)
    {
        if (!sk.secret_key_generated_)
        {
        ...
        input_storage_manager(
            ...
            [&](Secretkey<Scheme::RTF>& sk_)
            {
                input_storage_manager(
                    rk_stage_1,
                    [&](MultipartyRelinkey<Scheme::RTF>& rk_stage_1_)
                    {
                        output_storage_manager(
                            rk_stage_2,
                            [&](MultipartyRelinkey<Scheme::RTF>& rk_stage_2_)
                            {
                                DeviceVector<Data64> random_values(
    ...
    __host__ void
    HEMultiPartyManager<Scheme::RTF>::generate_bfv_relin_key_method_II_stage_1(
        MultipartyRelinkey<Scheme::RTF>& rk, Secretkey<Scheme::RTF>& sk,
        const ExecutionOptions& options)
    {
        if (!sk.secret_key_generated_)
    ...
    __host__ void
    HEMultiPartyManager<Scheme::RTF>::generate_bfv_relin_key_method_II_stage_3(
        MultipartyRelinkey<Scheme::RTF>& rk_stage_1,
        MultipartyRelinkey<Scheme::RTF>& rk_stage_2, Secretkey<Scheme::RTF>& sk,
        const ExecutionOptions& options)
    {
    ...
    __host__ void HEMultiPartyManager<Scheme::RTF>::generate_relin_key_stage_2(
        std::vector<MultipartyRelinkey<Scheme::RTF>>& all_rk,
        MultipartyRelinkey<Scheme::RTF>& rk, const ExecutionOptions& options)
    {
        ...
        input_vector_storage_manager(
            all_rk,
            [&](std::vector<MultipartyRelinkey<Scheme::RTF>>& all_rk_)
            {
                output_storage_manager(
                    rk,
                    [&](MultipartyRelinkey<Scheme::RTF>& rk_)
    ...
    __host__ void HEMultiPartyManager<Scheme::RTF>::generate_relin_key_stage_4(
        std::vector<MultipartyRelinkey<Scheme::RTF>>& all_rk,
        MultipartyRelinkey<Scheme::RTF>& rk_common_stage1,
        Relinkey<Scheme::RTF>& rk, const ExecutionOptions& options)
    {
        int participant_count = all_rk.size();
        ...
        input_vector_storage_manager(
            ...
            [&](std::vector<MultipartyRelinkey<Scheme::RTF>>& all_rk_)
            {
                input_storage_manager(
                    rk_common_stage1,
                    [&](MultipartyRelinkey<Scheme::RTF>& rk_common_stage1_)
                    {
                        output_storage_manager(
                            rk,
                            [&](Relinkey<Scheme::RTF>& rk_)
                            {
                                DeviceVector<Data64> output_memory(
    ...
    __host__ void
    HEMultiPartyManager<Scheme::RTF>::generate_galois_key_method_I_stage_1(
        MultipartyGaloiskey<Scheme::RTF>& gk, Secretkey<Scheme::RTF>& sk,
        const ExecutionOptions& options)
    {
        if (!sk.secret_key_generated_)
        {
    ...
    __host__ void
    HEMultiPartyManager<Scheme::RTF>::generate_galois_key_method_II_stage_1(
        MultipartyGaloiskey<Scheme::RTF>& gk, Secretkey<Scheme::RTF>& sk,
        const ExecutionOptions& options)
    {
        if (!sk.secret_key_generated_)
    ...
    __host__ void HEMultiPartyManager<Scheme::RTF>::generate_galois_key_stage_2(
        std::vector<MultipartyGaloiskey<Scheme::RTF>>& all_gk,
        Galoiskey<Scheme::RTF>& gk, const ExecutionOptions& options)
    {
    ...
    __host__ void HEMultiPartyManager<Scheme::RTF>::partial_decrypt_stage_1(
        Ciphertext<Scheme::RTF>& ciphertext, Secretkey<Scheme::RTF>& sk,
        Ciphertext<Scheme::RTF>& partial_ciphertext, const cudaStream_t stream)
    {
    ...
    __host__ void HEMultiPartyManager<Scheme::RTF>::partial_decrypt_stage_2(
        std::vector<Ciphertext<Scheme::RTF>>& ciphertexts,
        Plaintext<Scheme::RTF>& plaintext, const cudaStream_t stream)
    {
    ...
    __host__ void
    HEMultiPartyManager<Scheme::RTF>::distributed_bootstrapping_stage1(
        Ciphertext<Scheme::RTF>& common, Ciphertext<Scheme::RTF>& output,
        Secretkey<Scheme::RTF>& secret_key, const RNGSeed& seed,
        const cudaStream_t stream)
    {
    ...
    __host__ void
    HEMultiPartyManager<Scheme::RTF>::distributed_bootstrapping_stage2(
        std::vector<Ciphertext<Scheme::RTF>>& ciphertexts,
        Ciphertext<Scheme::RTF>& common, Ciphertext<Scheme::RTF>& output,
