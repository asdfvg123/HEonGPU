...
#ifndef HEONGPU_BFV_MPC_MANAGER_H
#define HEONGPU_BFV_MPC_MANAGER_H
...
{
    /**
     * @class HEMultiPartyManager<Scheme::RTF>
     * @brief High-level controller for all multi-party BFV protocols
     ...
     */
    template <> class HEMultiPartyManager<Scheme::RTF>
    {
      public:
        /**
         ...
         */
        __host__ HEMultiPartyManager(HEContext<Scheme::RTF>& context);
            ...
            input_storage_manager(
                ...
                [&](Secretkey<Scheme::RTF>& sk_)
                {
                    output_storage_manager(
                        pk,
                        [&](MultipartyPublickey<Scheme::RTF>& pk_)
                        {
            ...
            const ExecutionOptions& options = ExecutionOptions())
        {
            ...
            input_vector_storage_manager(
                all_pk,
                [&](std::vector<MultipartyPublickey<Scheme::RTF>>& all_pk_)
                {
                    output_storage_manager(
                        pk,
        ...
        __host__ void generate_relin_key_share(
            MultipartyRelinkey<Scheme::RTF>& rk_s1_common,
            MultipartyRelinkey<Scheme::RTF>& rk_new, Secretkey<Scheme::RTF>& sk,
            const ExecutionOptions& options = ExecutionOptions())
        {
        ...
        __host__ void assemble_relin_key_init(
            ...
            MultipartyRelinkey<Scheme::RTF>& rk,
            const ExecutionOptions& options = ExecutionOptions())
        {
         ...
         */
        __host__ void
        decrypt_partial(Ciphertext<Scheme::RTF>& ciphertext,
         ...
         */
        __host__ void
        decrypt(std::vector<Ciphertext<Scheme::RTF>>& ciphertexts,
                ...
                const ExecutionOptions& options = ExecutionOptions())
        {
            ...
            input_vector_storage_manager(
                ciphertexts,
                [&](std::vector<Ciphertext<Scheme::RTF>>& ciphertexts_)
                {
                    output_storage_manager(
                        plaintext,
            ...
            const ExecutionOptions& options = ExecutionOptions())
        {
            input_storage_manager(
                common,
                [&](Ciphertext<Scheme::RTF>& common_)
                {
                    input_storage_manager(
                        secret_key,
                        [&](Secretkey<Scheme::RTF>& secret_key_)
                        {
                            output_storage_manager(
                                output,
      ...
      private:
        __host__ void
        generate_public_key_stage1(MultipartyPublickey<Scheme::RTF>& pk,
                                   Secretkey<Scheme::RTF>& sk,
        ...
        __host__ void
        generate_relin_key_method_I_stage_1(MultipartyRelinkey<Scheme::RTF>& rk,
                                            Secretkey<Scheme::RTF>& sk,
                                            const ExecutionOptions& options);

        __host__ void generate_relin_key_method_I_stage_3(
            MultipartyRelinkey<Scheme::RTF>& rk_stage_1,
            MultipartyRelinkey<Scheme::RTF>& rk_stage_2,
            Secretkey<Scheme::RTF>& sk, const ExecutionOptions& options);

        __host__ void generate_bfv_relin_key_method_II_stage_1(
            MultipartyRelinkey<Scheme::RTF>& rk, Secretkey<Scheme::RTF>& sk,
            const ExecutionOptions& options);

        __host__ void generate_bfv_relin_key_method_II_stage_3(
            MultipartyRelinkey<Scheme::RTF>& rk_stage_1,
            MultipartyRelinkey<Scheme::RTF>& rk_stage_2,
            Secretkey<Scheme::RTF>& sk, const ExecutionOptions& options);
        ...
        __host__ void
        partial_decrypt_stage_1(Ciphertext<Scheme::RTF>& ciphertext,
                                Secretkey<Scheme::RTF>& sk,
                                Ciphertext<Scheme::RTF>& partial_ciphertext,
                                const cudaStream_t stream);
...
#endif // HEONGPU_BFV_MPC_MANAGER_H
