...
namespace heongpu
{
    __host__ Relinkey<Scheme::RTF>::Relinkey(HEContext<Scheme::RTF>& context)
    {
    ...
    void Relinkey<Scheme::RTF>::store_in_device(cudaStream_t stream)
    {
    ...
    void Relinkey<Scheme::RTF>::store_in_host(cudaStream_t stream)
    {
        if (storage_type_ == storage_type::DEVICE)
        {
    ...
    Data64* Relinkey<Scheme::RTF>::data()
    {
        if (storage_type_ == storage_type::DEVICE)
        {
    ...
    void Relinkey<Scheme::RTF>::save(std::ostream& os) const
    {
    ...
    void Relinkey<Scheme::RTF>::load(std::istream& is)
    {
        if ((!relin_key_generated_))
        {
    ...
    int Relinkey<Scheme::RTF>::memory_size()
    {
        if (storage_type_ == storage_type::DEVICE)
        {
    ...
    void Relinkey<Scheme::RTF>::memory_clear(cudaStream_t stream)
    {
    ...
    void
    Relinkey<Scheme::RTF>::memory_set(DeviceVector<Data64>&& new_device_vector)
    {
        storage_type_ = storage_type::DEVICE;
    ...
    void Relinkey<Scheme::RTF>::copy_to_device(cudaStream_t stream)
    {
        if (storage_type_ == storage_type::DEVICE)
        {
            // pass
    ...
    void Relinkey<Scheme::RTF>::remove_from_device(cudaStream_t stream)
    {
        if (storage_type_ == storage_type::DEVICE)
        {
            device_location_.resize(0, stream);
    ...
    void Relinkey<Scheme::RTF>::remove_from_host()
    {
        if (storage_type_ == storage_type::DEVICE)
        {
            // pass
    ...
    __host__ MultipartyRelinkey<Scheme::RTF>::MultipartyRelinkey(
        HEContext<Scheme::RTF>& context, const RNGSeed seed)
        : Relinkey(context), seed_(seed)
    {
    }

    __host__ Galoiskey<Scheme::RTF>::Galoiskey(HEContext<Scheme::RTF>& context)
    {
        if (!context.context_generated_)
        {
            throw std::invalid_argument("HEContext is not generated!");
    ...
    __host__
    Galoiskey<Scheme::RTF>::Galoiskey(HEContext<Scheme::RTF>& context,
    ...
    void Galoiskey<Scheme::RTF>::store_in_device(cudaStream_t stream)
    {
        if (storage_type_ == storage_type::DEVICE)
        {
            // pass
    ...
    void Galoiskey<Scheme::RTF>::store_in_host(cudaStream_t stream)
    {
        if (storage_type_ == storage_type::DEVICE)
        {
    ...
    Data64* Galoiskey<Scheme::RTF>::data(size_t i)
    {
        if (storage_type_ == storage_type::DEVICE)
        {
    ...
    Data64* Galoiskey<Scheme::RTF>::c_data()
    {
        if (storage_type_ == storage_type::DEVICE)
        {
    ...
    void Galoiskey<Scheme::RTF>::save(std::ostream& os) const
    {
    ...
    void Galoiskey<Scheme::RTF>::load(std::istream& is)
    {
        if ((!galois_key_generated_))
        {
            is.read((char*) &scheme_, sizeof(scheme_));
    ...
    __host__ MultipartyGaloiskey<Scheme::RTF>::MultipartyGaloiskey(
        HEContext<Scheme::RTF>& context, const RNGSeed seed)
    ...
    __host__ MultipartyGaloiskey<Scheme::RTF>::MultipartyGaloiskey(
        HEContext<Scheme::RTF>& context, std::vector<int>& shift_vec,
        const RNGSeed seed)
    ...
    __host__ MultipartyGaloiskey<Scheme::RTF>::MultipartyGaloiskey(
        HEContext<Scheme::RTF>& context, std::vector<uint32_t>& galois_elts,
        const RNGSeed seed)
        : Galoiskey(context, galois_elts), seed_(seed)
    {
    }

    __host__ Switchkey<Scheme::RTF>::Switchkey(HEContext<Scheme::RTF>& context)
    {
        if (!context.context_generated_)
        {
            throw std::invalid_argument("HEContext is not generated!");
    ...
    void Switchkey<Scheme::RTF>::store_in_device(cudaStream_t stream)
    {
        if (storage_type_ == storage_type::DEVICE)
        {
            // pass
    ...
    void Switchkey<Scheme::RTF>::store_in_host(cudaStream_t stream)
    {
        if (storage_type_ == storage_type::DEVICE)
        {
    ...
    Data64* Switchkey<Scheme::RTF>::data()
    {
        if (storage_type_ == storage_type::DEVICE)
        {
            return device_location_.data();
    ...
    void Switchkey<Scheme::RTF>::save(std::ostream& os) const
    {
    ...
    void Switchkey<Scheme::RTF>::load(std::istream& is)
    {
        if ((!switch_key_generated_))
        {
            is.read((char*) &scheme_, sizeof(scheme_));
    ...
    int Switchkey<Scheme::RTF>::memory_size()
    {
        if (storage_type_ == storage_type::DEVICE)
        {
            return device_location_.size();
    ...
    void Switchkey<Scheme::RTF>::memory_clear(cudaStream_t stream)
    {
        if (device_location_.size() > 0)
        {
            device_location_.resize(0, stream);
    ...
    void
    Switchkey<Scheme::RTF>::memory_set(DeviceVector<Data64>&& new_device_vector)
    {
        storage_type_ = storage_type::DEVICE;
        device_location_ = std::move(new_device_vector);
    ...
    void Switchkey<Scheme::RTF>::copy_to_device(cudaStream_t stream)
    {
        if (storage_type_ == storage_type::DEVICE)
        {
            // pass
    ...
    void Switchkey<Scheme::RTF>::remove_from_device(cudaStream_t stream)
    {
        if (storage_type_ == storage_type::DEVICE)
        {
            device_location_.resize(0, stream);
    ...
    void Switchkey<Scheme::RTF>::remove_from_host()
    {
        if (storage_type_ == storage_type::DEVICE)
        {
            // pass
