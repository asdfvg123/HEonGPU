...
#ifndef HEONGPU_RTF_PUBLICKEY_H
#define HEONGPU_RTF_PUBLICKEY_H
...
namespace heongpu
{
     ...
     */
    template <> class Publickey<Scheme::RTF>
    {
      ...
      public:
         ...
         */
        __host__ Publickey(HEContext<Scheme::RTF>& context);
    ...
    template <>
    class MultipartyPublickey<Scheme::RTF> : public Publickey<Scheme::RTF>
    {
        template <Scheme S> friend class HEKeyGenerator;

      public:
        __host__ MultipartyPublickey(HEContext<Scheme::RTF>& context,
                                     const RNGSeed seed);
