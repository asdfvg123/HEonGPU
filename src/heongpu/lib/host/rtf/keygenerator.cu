...
{
    __host__
    HEKeyGenerator<Scheme::RTF>::HEKeyGenerator(HEContext<Scheme::RTF>& context)
    {
    ...
    __host__ void HEKeyGenerator<Scheme::RTF>::generate_secret_key(
        Secretkey<Scheme::RTF>& sk, const ExecutionOptions& options)
    {
    ...
    __host__ void HEKeyGenerator<Scheme::RTF>::generate_public_key(
        Publickey<Scheme::RTF>& pk, Secretkey<Scheme::RTF>& sk,
    ...
    __host__ void HEKeyGenerator<Scheme::RTF>::generate_relin_key_method_I(
        Relinkey<Scheme::RTF>& rk, Secretkey<Scheme::RTF>& sk,
        const ExecutionOptions& options)
    {
        if (!sk.secret_key_generated_)
        {
    ...
    __host__ void HEKeyGenerator<Scheme::RTF>::generate_bfv_relin_key_method_II(
        Relinkey<Scheme::RTF>& rk, Secretkey<Scheme::RTF>& sk,
        const ExecutionOptions& options)
    {
        if (!sk.secret_key_generated_)
    ...
    __host__ void
    HEKeyGenerator<Scheme::RTF>::generate_bfv_relin_key_method_III(
        Relinkey<Scheme::RTF>& rk, Secretkey<Scheme::RTF>& sk,
        const ExecutionOptions& options)
    {
        if (!sk.secret_key_generated_)
    ...
    __host__ void HEKeyGenerator<Scheme::RTF>::generate_galois_key_method_I(
        Galoiskey<Scheme::RTF>& gk, Secretkey<Scheme::RTF>& sk,
        const ExecutionOptions& options)
    {
        if (!sk.secret_key_generated_)
        {
    ...
    __host__ void
    HEKeyGenerator<Scheme::RTF>::generate_bfv_galois_key_method_II(
        Galoiskey<Scheme::RTF>& gk, Secretkey<Scheme::RTF>& sk,
        const ExecutionOptions& options)
    {
        if (!sk.secret_key_generated_)
    ...
    __host__ void HEKeyGenerator<Scheme::RTF>::generate_switch_key_method_I(
        Switchkey<Scheme::RTF>& swk, Secretkey<Scheme::RTF>& new_sk,
        Secretkey<Scheme::RTF>& old_sk, const ExecutionOptions& options)
    {
        ...
        input_storage_manager(
            old_sk,
            [&](Secretkey<Scheme::RTF>& old_sk_)
            {
                input_storage_manager(
                    new_sk,
                    [&](Secretkey<Scheme::RTF>& new_sk_)
                    {
                        output_storage_manager(
                            swk,
                            [&](Switchkey<Scheme::RTF>& swk_)
                            {
                                DeviceVector<Data64> errors_a(
    ...
    __host__ void
    HEKeyGenerator<Scheme::RTF>::generate_bfv_switch_key_method_II(
        Switchkey<Scheme::RTF>& swk, Secretkey<Scheme::RTF>& new_sk,
        Secretkey<Scheme::RTF>& old_sk, const ExecutionOptions& options)
    {
        if (!old_sk.secret_key_generated_)
