...
#ifndef HEONGPU_RTF_KEYGENERATOR_H
#define HEONGPU_RTF_KEYGENERATOR_H
...
namespace heongpu
{
     ...
     */
    template <> class HEKeyGenerator<Scheme::RTF>
    {
      public:
        /**
         ...
         */
        __host__ HEKeyGenerator(HEContext<Scheme::RTF>& context);
         ...
         */
        __host__ void
        generate_relin_key(Relinkey<Scheme::RTF>& rk,
                           Secretkey<Scheme::RTF>& sk,
                           const ExecutionOptions& options = ExecutionOptions())
        {
      ...
      private:
        __host__ void
        generate_relin_key_method_I(Relinkey<Scheme::RTF>& rk,
                                    Secretkey<Scheme::RTF>& sk,
                                    const ExecutionOptions& options);

        __host__ void
        generate_bfv_relin_key_method_II(Relinkey<Scheme::RTF>& rk,
                                         Secretkey<Scheme::RTF>& sk,
                                         const ExecutionOptions& options);

        __host__ void
        generate_bfv_relin_key_method_III(Relinkey<Scheme::RTF>& rk,
                                          Secretkey<Scheme::RTF>& sk,
                                          const ExecutionOptions& options);

        __host__ void
        generate_galois_key_method_I(Galoiskey<Scheme::RTF>& gk,
                                     Secretkey<Scheme::RTF>& sk,
                                     const ExecutionOptions& options);

        __host__ void
        generate_bfv_galois_key_method_II(Galoiskey<Scheme::RTF>& gk,
                                          Secretkey<Scheme::RTF>& sk,
                                          const ExecutionOptions& options);
