...
#ifndef HEONGPU_RTF_PLAINTEXT_H
#define HEONGPU_RTF_PLAINTEXT_H
...
namespace heongpu
{
     ...
     */
    template <> class Plaintext<Scheme::RTF>
    {
      ...
      public:
         ...
         */
        explicit __host__
        Plaintext(HEContext<Scheme::RTF>& context,
