...
#ifndef HEONGPU_RTF_SECRETKEY_H
#define HEONGPU_RTF_SECRETKEY_H
...
namespace heongpu
{
     ...
     */
    template <> class Secretkey<Scheme::RTF>
    {
        ...
        friend class Secretkey<Scheme::CKKS>;
      ...
      public:
         ...
         */
        __host__ Secretkey(HEContext<Scheme::RTF>& context);
