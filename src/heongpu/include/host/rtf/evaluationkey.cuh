...
#ifndef HEONGPU_RTF_EVALUATIONKEY_H
#define HEONGPU_RTF_EVALUATIONKEY_H
...
namespace heongpu
{
     ...
     */
    template <> class Relinkey<Scheme::RTF>
    {
      ...
      public:
         ...
         */
        __host__ Relinkey(HEContext<Scheme::RTF>& context);
              ...
              relin_key_generated_(copy.relin_key_generated_)
        {
            if (copy.storage_type_ == storage_type::DEVICE)
            {
                ...
                cudaMemcpyAsync(device_location_.data(),
     ...
     */
    template <>
    class MultipartyRelinkey<Scheme::RTF> : public Relinkey<Scheme::RTF>
    {
        template <Scheme S> friend class HEKeyGenerator;
        template <typename T, typename F>
        friend void input_storage_manager(T& object, F function,
      ...
      public:
        __host__ MultipartyRelinkey(HEContext<Scheme::RTF>& context,
                                    const RNGSeed seed);
     ...
     */
    template <> class Galoiskey<Scheme::RTF>
    {
        template <Scheme S> friend class HEKeyGenerator;
        template <Scheme S> friend class HEOperator;
        template <Scheme S> friend class HEArithmeticOperator;
      ...
      public:
         ...
         * encryption parameters.
         */
        __host__ Galoiskey(HEContext<Scheme::RTF>& context);
     ...
     */
    template <>
    class MultipartyGaloiskey<Scheme::RTF> : public Galoiskey<Scheme::RTF>
    {
        template <Scheme S> friend class HEKeyGenerator;

      public:
        __host__ MultipartyGaloiskey(HEContext<Scheme::RTF>& context,
                                     const RNGSeed seed);
     ...
     * scenarios.
     */
    template <> class Switchkey<Scheme::RTF>
    {
        template <Scheme S> friend class HEKeyGenerator;
        template <Scheme S> friend class HEOperator;
        template <Scheme S> friend class HEArithmeticOperator;
      ...
      public:
         ...
         * encryption parameters.
         */
        __host__ Switchkey(HEContext<Scheme::RTF>& context);
...
#endif // HEONGPU_BFV_EVALUATIONKEY_H
