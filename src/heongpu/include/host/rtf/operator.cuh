...
#ifndef HEONGPU_RTF_OPERATOR_H
#define HEONGPU_RTF_OPERATOR_H
...
namespace heongpu
{
    ...
    template <> class HEOperator<Scheme::RTF>
    {
      ...
      protected:
         ...
         */
        __host__ HEOperator(HEContext<Scheme::RTF>& context,
      ...
      public:
         ...
         */
        __host__ void add(Ciphertext<Scheme::RTF>& input1,
         ...
         */
        __host__ void
        add_inplace(Ciphertext<Scheme::RTF>& input1,
                    Ciphertext<Scheme::RTF>& input2,
                    const ExecutionOptions& options = ExecutionOptions())
        {
         ...
         * stored.
         */
        __host__ void sub(Ciphertext<Scheme::RTF>& input1,
                          Ciphertext<Scheme::RTF>& input2,
                          Ciphertext<Scheme::RTF>& output,
                          const ExecutionOptions& options = ExecutionOptions());
         ...
         */
        __host__ void
        sub_inplace(Ciphertext<Scheme::RTF>& input1,
                    Ciphertext<Scheme::RTF>& input2,
                    const ExecutionOptions& options = ExecutionOptions())
        {
         ...
         */
        __host__ void
        negate(Ciphertext<Scheme::RTF>& input1, Ciphertext<Scheme::RTF>& output,
               const ExecutionOptions& options = ExecutionOptions());
         ...
         */
        __host__ void
        negate_inplace(Ciphertext<Scheme::RTF>& input1,
                       const ExecutionOptions& options = ExecutionOptions())
        {
         ...
         */
        __host__ void
        add_plain(Ciphertext<Scheme::RTF>& input1,
                  Plaintext<Scheme::RTF>& input2,
                  Ciphertext<Scheme::RTF>& output,
                  const ExecutionOptions& options = ExecutionOptions())
        {
         ...
         */
        __host__ void
        add_plain_inplace(Ciphertext<Scheme::RTF>& input1,
                          Plaintext<Scheme::RTF>& input2,
                          const ExecutionOptions& options = ExecutionOptions())
        {
            if (input1.relinearization_required_)
         ...
         */
        __host__ void
        sub_plain(Ciphertext<Scheme::RTF>& input1,
                  Plaintext<Scheme::RTF>& input2,
                  Ciphertext<Scheme::RTF>& output,
                  const ExecutionOptions& options = ExecutionOptions())
        {
         ...
         */
        __host__ void
        sub_plain_inplace(Ciphertext<Scheme::RTF>& input1,
                          Plaintext<Scheme::RTF>& input2,
                          const ExecutionOptions& options = ExecutionOptions())
        {
            if (input1.relinearization_required_)
         ...
         */
        __host__ void
        multiply(Ciphertext<Scheme::RTF>& input1,
                 Ciphertext<Scheme::RTF>& input2,
                 Ciphertext<Scheme::RTF>& output,
                 const ExecutionOptions& options = ExecutionOptions())
        {
         ...
         */
        __host__ void
        multiply_inplace(Ciphertext<Scheme::RTF>& input1,
                         Ciphertext<Scheme::RTF>& input2,
                         const ExecutionOptions& options = ExecutionOptions())
        {
         ...
         */
        __host__ void
        multiply_plain(Ciphertext<Scheme::RTF>& input1,
                       Plaintext<Scheme::RTF>& input2,
                       Ciphertext<Scheme::RTF>& output,
                       const ExecutionOptions& options = ExecutionOptions())
        {
         ...
         */
        __host__ void
        rotate_rows(Ciphertext<Scheme::RTF>& input1,
                    Ciphertext<Scheme::RTF>& output,
        ...
        __host__ void rotate_rows_inplace(
            Ciphertext<Scheme::RTF>& input1, Galoiskey<Scheme::RTF>& galois_key,
         ...
         */
        __host__ void
        rotate_columns(Ciphertext<Scheme::RTF>& input1,
                       Ciphertext<Scheme::RTF>& output,
         ...
         */
        __host__ void
        apply_galois(Ciphertext<Scheme::RTF>& input1,
                     Ciphertext<Scheme::RTF>& output,
         ...
         */
        __host__ void
        keyswitch(Ciphertext<Scheme::RTF>& input1,
                  Ciphertext<Scheme::RTF>& output,
                  Switchkey<Scheme::RTF>& switch_key,
                  const ExecutionOptions& options = ExecutionOptions())
        {
            if (input1.relinearization_required_)
            {
         ...
         */
        __host__ void
        transform_to_ntt(Plaintext<Scheme::RTF>& input1,
                         Plaintext<Scheme::RTF>& output,
                         const ExecutionOptions& options = ExecutionOptions())
        {
            if (!input1.in_ntt_domain_)
            {
                ...
                input_storage_manager(
                    input1,
                    [&](Plaintext<Scheme::RTF>& input1_)
                    {
                        output_storage_manager(
                            output,
                            [&](Plaintext<Scheme::RTF>& output_)
                            {
         ...
         */
        __host__ void
        transform_to_ntt(Ciphertext<Scheme::RTF>& input1,
                         Ciphertext<Scheme::RTF>& output,
                         const ExecutionOptions& options = ExecutionOptions())
        {
            if (input1.relinearization_required_)
         ...
         */
        __host__ void
        transform_from_ntt(Ciphertext<Scheme::RTF>& input1,
                           Ciphertext<Scheme::RTF>& output,
                           const ExecutionOptions& options = ExecutionOptions())
        {
            if (input1.relinearization_required_)
        ...
        __host__ Ciphertext<Scheme::RTF> multiply_matrix(
        ...
        __host__ heongpu::DeviceVector<Data64>
        pack_baby_steps_all_pow2_chain(
            heongpu::Ciphertext<heongpu::Scheme::RTF>  input,
            int g2,
      ...
      protected:
        ...
        __host__ void add_plain_bfv_inplace(Ciphertext<Scheme::RTF>& input1,
                                            Plaintext<Scheme::RTF>& input2,
                                            const cudaStream_t stream);

        __host__ void sub_plain_bfv(Ciphertext<Scheme::RTF>& input1,
                                    Plaintext<Scheme::RTF>& input2,
                                    Ciphertext<Scheme::RTF>& output,
                                    const cudaStream_t stream);

        __host__ void sub_plain_bfv_inplace(Ciphertext<Scheme::RTF>& input1,
                                            Plaintext<Scheme::RTF>& input2,
                                            const cudaStream_t stream);

        __host__ void multiply_bfv(Ciphertext<Scheme::RTF>& input1,
                                   Ciphertext<Scheme::RTF>& input2,
                                   Ciphertext<Scheme::RTF>& output,
                                   const cudaStream_t stream);

        __host__ void multiply_plain_bfv(Ciphertext<Scheme::RTF>& input1,
                                         Plaintext<Scheme::RTF>& input2,
                                         Ciphertext<Scheme::RTF>& output,
                                         const cudaStream_t stream);
        ...
        __host__ void
        relinearize_seal_method_inplace(Ciphertext<Scheme::RTF>& input1,
        ...
        __host__ void rotate_method_I(Ciphertext<Scheme::RTF>& input1,
                                      Ciphertext<Scheme::RTF>& output,
                                      Galoiskey<Scheme::RTF>& galois_key,
                                      int shift, const cudaStream_t stream);

        __host__ void rotate_method_II(Ciphertext<Scheme::RTF>& input1,
                                       Ciphertext<Scheme::RTF>& output,
                                       Galoiskey<Scheme::RTF>& galois_key,
                                       int shift, const cudaStream_t stream);
        ...
        __host__ void apply_galois_method_I(Ciphertext<Scheme::RTF>& input1,
                                            Ciphertext<Scheme::RTF>& output,
                                            Galoiskey<Scheme::RTF>& galois_key,
                                            int galois_elt,
                                            const cudaStream_t stream);

        __host__ void apply_galois_method_II(Ciphertext<Scheme::RTF>& input1,
                                             Ciphertext<Scheme::RTF>& output,
                                             Galoiskey<Scheme::RTF>& galois_key,
                                             int galois_elt,
                                             const cudaStream_t stream);
        ...
        __host__ void switchkey_method_I(Ciphertext<Scheme::RTF>& input1,
                                         Ciphertext<Scheme::RTF>& output,
                                         Switchkey<Scheme::RTF>& switch_key,
                                         const cudaStream_t stream);

        __host__ void switchkey_method_II(Ciphertext<Scheme::RTF>& input1,
                                          Ciphertext<Scheme::RTF>& output,
                                          Switchkey<Scheme::RTF>& switch_key,
                                          const cudaStream_t stream);
        ...
        __host__ void
        negacyclic_shift_poly_coeffmod(Ciphertext<Scheme::RTF>& input1,
                                       Ciphertext<Scheme::RTF>& output,
                                       int index, const cudaStream_t stream);

        ///////////////////////////////////////////////////

        __host__ void transform_to_ntt_bfv_plain(Plaintext<Scheme::RTF>& input1,
                                                 Plaintext<Scheme::RTF>& output,
                                                 const cudaStream_t stream);

        __host__ void
        transform_to_ntt_bfv_cipher(Ciphertext<Scheme::RTF>& input1,
                                    Ciphertext<Scheme::RTF>& output,
                                    const cudaStream_t stream);

        __host__ void
        transform_from_ntt_bfv_cipher(Ciphertext<Scheme::RTF>& input1,
                                      Ciphertext<Scheme::RTF>& output,
                                      const cudaStream_t stream);
     ...
     */
    template <>
    class HEArithmeticOperator<Scheme::RTF> : public HEOperator<Scheme::RTF>
    {
      public:
        /**
         ...
         */
        HEArithmeticOperator(HEContext<Scheme::RTF>& context,
                             HEEncoder<Scheme::RTF>& encoder);
    };
     ...
     */
    template <>
    class HELogicOperator<Scheme::RTF> : private HEOperator<Scheme::RTF>
    {
      public:
        /**
         ...
         */
        HELogicOperator(HEContext<Scheme::RTF>& context,
                        HEEncoder<Scheme::RTF>& encoder);
         ...
         */
        __host__ void NOT(Ciphertext<Scheme::RTF>& input1,
                          Ciphertext<Scheme::RTF>& output,
                          const ExecutionOptions& options = ExecutionOptions())
        {
         ...
         */
        __host__ void
        NOT_inplace(Ciphertext<Scheme::RTF>& input1,
                    const ExecutionOptions& options = ExecutionOptions())
        {
            ExecutionOptions options_inner =
                ExecutionOptions()
         ...
         * @param options Execution options.
         */
        __host__ void AND(Ciphertext<Scheme::RTF>& input1,
                          Ciphertext<Scheme::RTF>& input2,
                          Ciphertext<Scheme::RTF>& output,
                          Relinkey<Scheme::RTF>& relin_key,
                          const ExecutionOptions& options = ExecutionOptions())
         ...
         */
        __host__ void
        AND_inplace(Ciphertext<Scheme::RTF>& input1,
                    Ciphertext<Scheme::RTF>& input2,
                    Relinkey<Scheme::RTF>& relin_key,
                    const ExecutionOptions& options = ExecutionOptions())
        {
         ...
         * @param options Execution options.
         */
        __host__ void OR(Ciphertext<Scheme::RTF>& input1,
                         Ciphertext<Scheme::RTF>& input2,
                         Ciphertext<Scheme::RTF>& output,
                         Relinkey<Scheme::RTF>& relin_key,
                         const ExecutionOptions& options = ExecutionOptions())
        {
            ...
            Ciphertext<Scheme::RTF> inner_input1 =
                operator_from_ciphertext(input1, options.stream_);
            Ciphertext<Scheme::RTF> inner_input2 =
                operator_from_ciphertext(input1, options.stream_);
         ...
         */
        __host__ void
        OR_inplace(Ciphertext<Scheme::RTF>& input1,
                   Ciphertext<Scheme::RTF>& input2,
                   Relinkey<Scheme::RTF>& relin_key,
                   const ExecutionOptions& options = ExecutionOptions())
        {
         ...
         * @param options Execution options.
         */
        __host__ void XOR(Ciphertext<Scheme::RTF>& input1,
                          Ciphertext<Scheme::RTF>& input2,
                          Ciphertext<Scheme::RTF>& output,
                          Relinkey<Scheme::RTF>& relin_key,
                          const ExecutionOptions& options = ExecutionOptions())
         ...
         */
        __host__ void
        XOR_inplace(Ciphertext<Scheme::RTF>& input1,
                    Ciphertext<Scheme::RTF>& input2,
                    Relinkey<Scheme::RTF>& relin_key,
                    const ExecutionOptions& options = ExecutionOptions())
        {
         ...
         * @param options Execution options.
         */
        __host__ void NAND(Ciphertext<Scheme::RTF>& input1,
                           Ciphertext<Scheme::RTF>& input2,
                           Ciphertext<Scheme::RTF>& output,
                           Relinkey<Scheme::RTF>& relin_key,
                           const ExecutionOptions& options = ExecutionOptions())
         ...
         */
        __host__ void
        NAND_inplace(Ciphertext<Scheme::RTF>& input1,
                     Ciphertext<Scheme::RTF>& input2,
                     Relinkey<Scheme::RTF>& relin_key,
                     const ExecutionOptions& options = ExecutionOptions())
        {
         ...
         * @param options Execution options.
         */
        __host__ void NOR(Ciphertext<Scheme::RTF>& input1,
                          Ciphertext<Scheme::RTF>& input2,
                          Ciphertext<Scheme::RTF>& output,
                          Relinkey<Scheme::RTF>& relin_key,
                          const ExecutionOptions& options = ExecutionOptions())
         ...
         */
        __host__ void
        NOR_inplace(Ciphertext<Scheme::RTF>& input1,
                    Ciphertext<Scheme::RTF>& input2,
                    Relinkey<Scheme::RTF>& relin_key,
                    const ExecutionOptions& options = ExecutionOptions())
        {
         ...
         * @param options Execution options.
         */
        __host__ void XNOR(Ciphertext<Scheme::RTF>& input1,
                           Ciphertext<Scheme::RTF>& input2,
                           Ciphertext<Scheme::RTF>& output,
                           Relinkey<Scheme::RTF>& relin_key,
                           const ExecutionOptions& options = ExecutionOptions())
         ...
         */
        __host__ void
        XNOR_inplace(Ciphertext<Scheme::RTF>& input1,
                     Ciphertext<Scheme::RTF>& input2,
                     Relinkey<Scheme::RTF>& relin_key,
                     const ExecutionOptions& options = ExecutionOptions())
        {
        ...
        __host__ void
        one_minus_cipher(Ciphertext<Scheme::RTF>& input1,
                         Ciphertext<Scheme::RTF>& output,
                         const ExecutionOptions& options = ExecutionOptions());
