...
#ifndef HEONGPU_RTF_ENCODER_H
#define HEONGPU_RTF_ENCODER_H
...
namespace heongpu
{
     ...
     * workflows.
     */
    template <> class HEEncoder<Scheme::RTF>
    {
      ...
      public:
         ...
         * encode parameters.
         */
        __host__ HEEncoder(HEContext<Scheme::RTF>& context);
         ...
         */
        __host__ void
        encode(Plaintext<Scheme::RTF>& plain,
         ...
         */
        __host__ void
        decode(std::vector<uint64_t>& message, Plaintext<Scheme::RTF>& plain,
               const ExecutionOptions& options = ExecutionOptions())
        {
         ...
         */
        __host__ void
        decode(std::vector<int64_t>& message, Plaintext<Scheme::RTF>& plain,
               const ExecutionOptions& options = ExecutionOptions())
        {
            input_storage_manager(
                plain,
         ...
         */
        __host__ void
        decode(HostVector<uint64_t>& message, Plaintext<Scheme::RTF>& plain,
               const ExecutionOptions& options = ExecutionOptions())
        {
            input_storage_manager(
                plain,
         ...
         */
        __host__ void
        decode(HostVector<int64_t>& message, Plaintext<Scheme::RTF>& plain,
               const ExecutionOptions& options = ExecutionOptions())
        {
            input_storage_manager(
                plain,
      ...
      private:
        __host__ void encode_bfv(Plaintext<Scheme::RTF>& plain,
                                 const std::vector<uint64_t>& message,
