...
#ifndef HEONGPU_RTF_ENCRYPTOR_H
#define HEONGPU_RTF_ENCRYPTOR_H
...
namespace heongpu
{
     ...
     */
    template <> class HEEncryptor<Scheme::RTF>
    {
      public:
        /**
         ...
         * encryption.
         */
        __host__ HEEncryptor(HEContext<Scheme::RTF>& context,
                             Publickey<Scheme::RTF>& public_key);
         ...
         */
        __host__ void
        encrypt(Ciphertext<Scheme::RTF>& ciphertext,
      ...
      private:
        __host__ void encrypt_bfv(Ciphertext<Scheme::RTF>& ciphertext,
                                  Plaintext<Scheme::RTF>& plaintext,
