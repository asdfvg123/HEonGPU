...
#ifndef HEONGPU_RTF_CIPHERTEXT_H
#define HEONGPU_RTF_CIPHERTEXT_H
...
namespace heongpu
{
    ...
    template <> class Ciphertext<Scheme::RTF>
    {
      ...
      public:
         ...
         */
        __host__
        Ciphertext(HEContext<Scheme::RTF>& context,
...
#endif // HEONGPU_RTF_CIPHERTEXT_H